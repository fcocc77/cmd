...
# sudo yum -y --enablerepo=elrepo-kernel install ${packages[@]}
#
...
sudo yum -y install $hoztnode/kernel-ml-5.4.6-1.el7.elrepo.x86_64.rpm
sudo yum -y install $hoztnode/kernel-ml-devel-5.4.6-1.el7.elrepo.x86_64.rpm
sudo yum -y install $hoztnode/kernel-ml-headers-5.4.6-1.el7.elrepo.x86_64.rpm
